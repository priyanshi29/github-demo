...
def populate_data(**context):
    psql_conn1 = "host=glints_project_final-database_source-1 port=5432 dbname=glints_db user=airflow password=airflow"            
    psql_conn2 = "host=glints_project_final-database_target-1 port=5432 dbname=glints_db user=airflow password=airflow"   
